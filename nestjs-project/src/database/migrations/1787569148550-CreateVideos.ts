...
export class CreateVideos1787569148550 implements MigrationInterface {
  name = 'CreateVideos1787569148550';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "videos" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "channel_id" uuid NOT NULL, "title" character varying(255) NOT NULL, "original_filename" character varying(255) NOT NULL, "status" "public"."videos_status_enum" NOT NULL DEFAULT 'draft', "object_key" character varying(1024) NOT NULL, "upload_id" character varying(512), "thumbnail_key" character varying(1024), "duration_seconds" integer, "size_bytes" bigint, "mime_type" character varying(255), "failure_reason" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_5c8d5988bc60abb9f7b5d14371d" UNIQUE ("object_key"), CONSTRAINT "PK_e4c86c0cf95aff16e9fb8220f6b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
